...
COMMENT ON COLUMN financial_entities.entity_type IS 'Type of institution';
COMMENT ON COLUMN financial_entities.nmls_id IS 'NMLS ID';
COMMENT ON COLUMN financial_entities.compliance_status IS 'Compliance status';
COMMENT ON COLUMN financial_entities.risk_level IS 'Risk level';
...
COMMENT ON COLUMN compliance_violations.severity IS 'Severity level';
COMMENT ON COLUMN compliance_violations.fine_amount IS 'Monetary penalty';
...
COMMENT ON COLUMN alert_notifications.alert_priority IS 'Priority level';
